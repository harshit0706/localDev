...
export default class PdfGeneratorLwc extends LightningElement {
    ...
    pdfHandler(){
        ...
        .then(result=>{
            ...
            window.open(`https://hdinc-dev-ed.file.force.com/servlet/servlet.FileDownload?file=${result.Id}`)
        })
        .catch(error=>{
            console.error(error)
        })
    ...
    // renderAsPdf vfPage
    // pdfController LWC controller
    // pdfPageController vfPage controller
}